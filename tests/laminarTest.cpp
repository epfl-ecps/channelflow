	...
	//const int  maxscale = 2;    
        ...
        if (taskid == 0) {
            ...
            cout << setw(W) << "constr" << setw(W) << "a" << setw(W) << "b" << setw(W) << "ua" << setw(W) << "ub"
                 << setw(W) << "Re" << setw(W) << "Vsuck" << setw(W) << "dPdx" << setw(W) << "Ubulk"
		 << setw(W) << "Vsuck H/nu" 
                 << setw(W) << "erreqn" << setw(W) << "errwall" << setw(W) << "errbulk" << setw(W) << "errtot"
		 << setw(W) << "status\n";
            cout << endl << endl;
        }
		...
		normeqn += abs(dPdx);
            ...
            if (taskid == 0)
                cout << setw(W) << constraint_ << setw(W) << a << setw(W) << b << setw(W) << ua << setw(W) << ub
                     << setw(W) << Reynolds << setw(W) << Vsuck << setw(W) << dPdx << setw(W) << Ubulk
		     << setw(W) << Vsuck*(b-a)/nu
                     << setw(W) << erreqn << setw(W) << errwall << setw(W) << errbulk << setw(W) << errtot
		     << setw(W) << status
                     << endl;
